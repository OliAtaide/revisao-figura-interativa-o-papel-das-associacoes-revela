timeline = [
    {
        ...
        alt: 'Fotografia em escala de cinza horizontal com aperto de mãos.',
        texto: `
    ...
    },
    {
        ...
        alt: `
        Fotografia colorida horizontal de duas mãos, tocando as pontas dos dedos, formando uma cobertura,
        cobrindo recorte de papel com silhueta de família de mãos dadas, com um homem, uma mulher e duas crianças.
        `,
        texto: `
    ...
    },
    {
        ...
        alt : `
        Fotografia colorida horizontal de uma medalha de bronze,
        com pequenas estrelas cunhadas circundando a moeda e uma grande estrela,
        no centro da medalha, com sigla LBA.
    ...
    },
    {
        ...
        alt: `
        Brasão da Irmandade da Santa Casa da Misericórdia. Ao centro, imagem de santa, com véu cobrindo cabelos,
        segurando uma criança nos braços. Acima da imagem, estrela estilizada de cinco pontas. Nas laterais do brasão,
        ramos de café, à esquerda e de trigo, à direita.
        `,
        texto: `
    ...
    },
    {
        ...
        alt: 'Brasão colorido da Organização das Nações Unidas (ONU), com planificação do globo terrestre, centrada no Polo Norte, com ramos de oliveira nas laterais da planificação.',
        texto: `
    ...
    },
    {
        ...
        alt: 'Ilustração colorida quadrada do mapa do Brasil formada por uma aglomeração de pessoas em pé.',
        texto: 'Já havia mais de 10 mil ONGs no Brasil.'
    },
    {
        ano: '1980',
        imagem: '../imgs/timeline1/imagem7.jpeg',
        alt: 'Fotomontagem colorida horizontal formada por mãos erguidas para o alto, lado a lado, com palmas virada para a frente, formando a bandeira do Brasil. Ao fundo, gradação de azul claro, semelhante ao céu.',
        texto: `
    ...
    },
    {
        ...
        alt: 'Ilustração colorida quadrada do mapa do Brasil formada por balões coloridos. Saindo de trás do mapa, braços abraçam o mapa.',
